...
def save_obs_oifits(obs, fname, flux=1.0):
    ...
    # create dictionary
    union = {}
    union = io_.writeoifits.arrayUnion(antennaNames, union)
    ...
    ant1 = io_.writeoifits.convertStrings(data['t1'], union)
    ant2 = io_.writeoifits.convertStrings(data['t2'], union)
    ...
    # convert antenna name strings to number identifiers
    biarr_ant1 = io_.writeoifits.convertStrings(biarr['t1'], union)
    biarr_ant2 = io_.writeoifits.convertStrings(biarr['t2'], union)
    biarr_ant3 = io_.writeoifits.convertStrings(biarr['t3'], union)
    ...
    io_.writeoifits.writeOIFITS(fname, obs.ra, obs.dec, obs.rf, obs.bw, intTime,
