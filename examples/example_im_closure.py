...
def main():
    ...
    # tstart_hr is the GMST time of the start of 
    # the observation and tstop_hr is the GMST time of the end
    ...
    obs = im.observe(
        ...
        ampcal=True, phasecal=False,ttype='nfft'
        )
    # Resolution
    ...
    prior_fwhm = 80*ehtim.RADPERUAS # Gaussian size in microarcssec
    ...
    flux = zbl
    imgr  = ehtim.imager.Imager(obs, gaussprior, gaussprior, flux,
